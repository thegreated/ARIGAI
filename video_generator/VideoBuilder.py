...
class VideoBuilder:
    ...
    def generate_video(self,title_text):
        ...
        title_fontsize = self.fontsize + 2
        w, h = self.frame_size

        title_clip = TextClip(title_text, fontsize=title_fontsize, font=self.font, color='black', method='caption', size=(w - 80, None)).set_duration(self.duration)
    ...
    @staticmethod
    def generate(title,bg_images, bg_music_audio, narration_path, output_names= "final_output -last-final-1.mp4"):
