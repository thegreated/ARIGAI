...
class VideoBuilder:
    ...
    def transcribe(self):
        ...
        with open(os.getenv("JSON_FILES"), "w") as f:
    ...
    @staticmethod
    def generate(bg_images,bg_music_audio, narration_path , output_names="final_output -last-final-1.mp4"):
        """bg_images = [
        ...
        audio_path="C:/python_resources/narration/narration.wav
        """
